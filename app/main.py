...
def format_single_linter_file(file_path: str, errors: list) -> dict:
    formatted_errors = [format_linter_error(error) for error in errors] return {"path": file_path, "status": "failed" if len(errors) > 0 else "passed", "errors": formatted_errors,}
